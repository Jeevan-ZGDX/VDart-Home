...
import type { AnalyzeResponse, HealthResponse, PoseResponse, RewriteResponse } from "@/lib/types";
              ...
              <CardContent className="flex flex-col gap-4">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <Badge variant={speechAvailable ? "secondary" : "destructive"}>
                    {speechAvailable ? "Speech recognition supported" : "Not supported in this browser"}
                  </Badge>
                </div>
